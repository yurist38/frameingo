Router.plugin('seo', {
    defaults: {
        ...
        image: `${document.location.origin}/images/instaphobia-preview.jpg`,
        meta: {
        ...
        og: {
            type: 'website',
            title: 'FrameInGo - Live Instashow',
            descripttion: 'Live Instagram Feed Slideshow for your event, party or just for fun!',
